...
class MemberAdmin(UserAdmin):
    list_display = ('email', 'user_id', 'username', 'is_active', 'social_type', 'language', 'date_joined', 'is_staff')
    ordering = ('user_id',)
    fieldsets = (
...
class GenreAdmin(admin.ModelAdmin):
    ordering = ['order']
    list_display = ('name', 'parent', 'sub_order', 'depth', 'order', 'is_shown', 'created_at',)
    search_fields = ['name']
