...
class Message(models.Model):
    ...
    image = models.ImageField("画像", upload_to = "static/images/message", max_length = 255, null = True, blank = True)
    sender = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="sent_messages", verbose_name="送信側")
    receiver = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="received_messages", verbose_name="受信側")
